...
public class ObAdapter extends PagerAdapter {
    ...
    private int images[] = {
            R.drawable.budget_icon8,
            R.drawable.time_icon8,
            R.drawable.health_icon8,
            R.drawable.ingredient_icon8,
    };
    ...
    public Object instantiateItem(@NonNull ViewGroup container, int position) {
        View view = layoutInflater.inflate(R.layout.page_ob,container,false);
